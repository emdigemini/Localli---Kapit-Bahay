            ...
            <div class="top">
              <div class="top-left">
                ...
                <div>
                  ...
                  <div class="name">John Lloyd V. Dela Cruz</div>
                  <div class="distance">4 km away</div>
                </div>
              </div>
              <div class="top-right">
                <div class="age">Age: 20</div>
                <div class="course"><b>Course:</b> BS - Information Technology</div>
                <div class="course"><b>College:</b> Student at East System Colleges of Rizal</div>
              </div>
            </div>
            <div class="desc">
          ...
          <div class="card">
            <div class="top">
              <div class="top-left">
                ...
                <div>
                  <div class="role">Student</div>
                  <div class="name">Jaworski B. Bautista</div>
                  <div class="distance">3 km away</div>
                </div>
              </div>
              <div class="top-right">
                <div class="age">Age: 20</div>
                <div class="course"><b>Course:</b> BS - Information Technology</div>
                <div class="course"><b>College:</b> Student at STI College<br/>Tanay Rizal</div>
              </div>
            </div>
            <div class="desc">
          ...
          <div class="card">
            <div class="top">
              <div class="top-left">
                ...
                <div>
                  <div class="role">Student</div>
                  <div class="name">Maria S. Puerta</div>
                  <div class="distance">7 km away</div>
                </div>
              </div>
              <div class="top-right">
                <div class="age">Age: 20</div>
            ...
            <div class="top">
              <div class="top-left">
                ...
                <div>
                  <div class="role">Student</div>
                  <div class="name">John Lloyd V. Dela Cruz</div>
                  <div class="distance">465 m away</div>
                </div>
              </div>
              <div class="top-right">
                <div class="age">Age: 20</div>
            ...
            <div class="top">
              <div class="top-left">
                ...
                <div>
                  ...
                  <div class="name">James K. Lebron</div>
                  <div class="distance">6 km away</div>
                </div>
              </div>
              <div class="top-right">
                <div class="age">Age: 20</div>
                <div class="course"><b>Course:</b> BS - Information Technology</div>
                <div class="work"><b>College:</b> Google PH / Accenture /  Orange & Bronze</div>
              </div>
            </div>
            <div class="desc">
...
function LocationIcon(){
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
      <circle cx="12" cy="9" r="2.5" fill="#0C6FFF" fill-opacity="0">
        <animate fill="freeze" attributeName="fill-opacity" begin="0.5s" dur="0.15s" values="0;1" />
      </circle>
      <path fill="none" stroke="#0C6FFF" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 20.5C12 20.5 11 19 11 18C11 17.5 11.5 17 12 17C12.5 17 13 17.5 13 18C13 19 12 20.5 12 20.5z">
