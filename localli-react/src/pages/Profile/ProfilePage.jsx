  ...
  return (
    <div className="profile-page">
      <div className="graphic-background">
        <img className="lalake" src="/image/lalake.png" alt="graphic-background" />
        <img className="babae" src="/image/babae.png" alt="graphic-background" />
      ...
      <div className="plane-background">
        <img className="plane-left" src="/image/plane-left.png" alt="plane-background" />
        <img className="plane-right" src="/image/plane-right.png" alt="plane-background" />
      </div>
    </div>
  )
}
...
function Toga(){
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
      <path fill="#262626" d="M12 3L1 9l4 2.18v6L12 21l7-3.82v-6l2-1.09V17h2V9zm6.82 6L12 12.72L5.18 9L12 5.28zM17 16l-5 2.72L7 16v-3.73L12 15l5-2.73z" stroke-width="0.5" stroke="none" />
    </svg>
  )
}
...
function Job(){
  return (
    ...
    <path fill="none" stroke="#000000ff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M30 8H2v18h28ZM20 8s0-4-4-4s-4 4-4 4M8 26V8m16 18V8" />
  </svg>
  )
}
